...
const BodyComponent = () => {
  return (
    <Card>
      <Flex className="body-component__flex" display={{ default: 'inlineFlex' }}>
        <FlexItem className="body-component--flex-item">
          <CardBody>
            <Content>
              <Content component={ContentVariants.h2}>See all your subscriptions</Content>
            </Content>
          </CardBody>
          <CardBody className="pf-u-pb-xs pf-u-mb-xs">
            <Content>
              <Content component={ContentVariants.h3}>Register your RHEL systems</Content>
              <Content className="pf-u-pb-xs pf-u-mb-xs" component={ContentVariants.p}>
                Get the full value of your RHEL subscriptions, including updates and security
                patches, through registration.
              </Content>
              <Content component={ContentVariants.ul}>
                <Content component="li" className="body-component--text-list-margins">
                  For a guided registration experience, try the{' '}
                  <Link target="_blank" to="/insights/registration" rel="noreferrer">
                    {' '}
          ...
          <CardBody className="body-component--flex-item body-component--text-list-margins">
            <Content>
              <Content component={ContentVariants.h3}>Activate Subscriptions Usage</Content>
              <Content component={ContentVariants.p}>
                Gain visibility into the usage of your subscriptions against your total capacity
                over time. Opt in to Subscriptions Usage today! &nbsp;
                <a
                  target="_blank"
          ...
          <CardBody className="body-component--flex-item pf-u-pt-md">
            <Content>
              <Content component={ContentVariants.h3}>Get the right usage data</Content>
              <Content component={ContentVariants.p}>
                Account-wide usage reporting relies on multiple data streams to power Subscriptions
                Usage. Make sure that the right data is flowing for accurate reporting. &nbsp;
                <a
                  target="_blank"
