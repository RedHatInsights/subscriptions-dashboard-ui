        ...
        <Flex display={{ default: 'inlineFlex' }} style={{ display: 'flex', flexWrap: 'nowrap', alignItems: 'start' }}>
            <FlexItem flex={{ default: 'flex_1' }}>
                <Card style={{ textAlign: 'center' }} className='portfolioFlex'>
                    <a target="_blank" href="https://www.redhat.com/en/technologies/linux-platforms/enterprise-linux">
            ...
            <FlexItem flex={{ default: 'flex_1' }}>
                <Card style={{ textAlign: 'center' }} className='portfolioFlex'>
                    <a target='_blank' href='https://www.redhat.com/en/technologies/management/ansible'>
                        <Button style={{ background: 'white', padding: 0}}>
            ...
            <FlexItem flex={{ default: 'flex_1' }}>
                <Card style={{ textAlign: 'center' }} className='portfolioFlex'>
                    <a target="_blank" href='https://www.redhat.com/en/technologies/all-products'>
                        <Button style={{ background: 'white', padding: 0 }}>
